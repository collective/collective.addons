...
class ContactProjectOwnerSchema(interface.Interface):
...
@implementer(ContactProjectOwnerSchema)
@adapter(interface.Interface)
class ContactProjectOwnerAdapter(object):
...
class ContactProjectOwnerForm(AutoExtensibleForm, form.Form):
    schema = ContactProjectOwnerSchema
    ...
    fields = field.Fields(ContactProjectOwnerSchema)
